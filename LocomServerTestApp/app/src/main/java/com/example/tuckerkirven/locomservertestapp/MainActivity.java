package com.example.tuckerkirven.locomservertestapp;
...
public class MainActivity extends ActionBarActivity {
    ...
    //scoring
    //when the player or opponent puts mark in a box the corresponding place in the array
    // gets incremented:
    //  0-2 columns left to right
    //  3-5 rows top down
    //  6 top left to bottom right
    //  7 bottom right to top left
    // if either reaches 3 that will be a win
    ...
    //if moves == 9 before a player has won both players will be disconnected and a tie
